...
int main(int argc, char **argv)
{
  ...
  half *d_b_c; 
  half *d_c_c; 
  cudaMalloc((void **)&d_a_c, sizeof(half)*120*120);
  cudaMalloc((void **)&d_b_c, sizeof(half)*120*120);
  cudaMalloc((void **)&d_c_c, sizeof(half)*120*120);
  ...
  cublasGemmEx(handle, CUBLAS_OP_N, CUBLAS_OP_N, 120, 120, 120, &alpha, d_a_c, CUDA_R_16F, 120, d_b_c, CUDA_R_16F, 120, &beta, d_c_c, CUDA_R_16F, 120, CUDA_R_16F, CUBLAS_GEMM_DEFAULT_TENSOR_OP);

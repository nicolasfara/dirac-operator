...
# 1 "main.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T185) {  __nv_dummy_param_ref(__T185); __nv_save_fatbinhandle_for_managed_rt(__T185); __cudaRegisterEntry(__T185, ((void ( *)(half *, size_t))kernel_fill_matrix), _Z18kernel_fill_matrixP6__halfm, (-1)); __cudaRegisterEntry(__T185, ((void ( *)(cuDoubleComplex *, cuDoubleComplex *, cuDoubleComplex *))mat_vec_mul), _Z11mat_vec_mulP7double2S0_S0_, (-1)); }
